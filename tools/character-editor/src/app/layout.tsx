...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="ja"><body><header className="app-header"><Link href="/" className="brand"><span aria-hidden="true">◈</span> CHARACTER WORKSHOP <small>SRPG</small></Link><nav aria-label="メインナビゲーション"><Link href="/dashboard">Dashboard</Link><Link href="/characters">Character Library</Link><Link href="/">Character Builder</Link><Link href="/variations">Variation Generator</Link><Link href="/assets">Asset Library</Link><Link href="/creator">Asset Creator</Link><Link href="/production">AI Production</Link><Link href="/validation">Validation</Link></nav><span className="local-label">LOCAL TOOL</span></header><main>{children}</main><footer>Character Asset Tool v0.1 <span>Source: Blockbench · Runtime: GLB · Y Up</span></footer></body></html>;
}
