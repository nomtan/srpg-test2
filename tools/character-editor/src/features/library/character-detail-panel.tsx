      ...
      {tab === "detail" ? (
        <div className="lib-detail-body">
          <dl>
            ...
            {generation && <>
              <dt>Generated by</dt>
              <dd><Link href={`/variations`}>{generation.preset}</Link>{generation.modified ? " · 手動編集あり" : ""}</dd>
              <dt>Seed</dt><dd>{generation.seed} · #{generation.index} / salt {generation.salt} (preset v{generation.presetVersion})</dd>
            </>}
          </dl>
          ...
          <div className="lib-actions">
            ...
            <button disabled={!!busy} onClick={() => {
              if (!stageRecipeForBuilder(recipe, record.name)) { setMsg("localStorage が使用できません。"); return; }
              router.push("/");
            }}>Open in Character Builder</button>
