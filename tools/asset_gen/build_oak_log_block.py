"""Build a one-cell oak-log block GLB with separate end and bark textures.

Run with Blender:
    blender --background --python tools/asset_gen/build_oak_log_block.py -- \
        --tex assets/texture/oak_log --out assets/props/log
"""
...
def main() -> None:
    ...
    end_path = tex_dir / "oak_log_end_01.png"
    side_path = tex_dir / "oak_log_side_01.png"
    ...
    reset_scene()
    obj = build_log(
        "prop_oak_log_block_01",
        make_material("MAT_oak_log_end", end_path),
        make_material("MAT_oak_log_side", side_path),
    )
    obj.select_set(True)
    bpy.context.view_layer.objects.active = obj
    output = out_dir / "prop_oak_log_block_01.glb"
