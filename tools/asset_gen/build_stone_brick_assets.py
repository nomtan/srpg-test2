"""Build stone-brick cubes and stairs as one-cell GLB assets.

Run with Blender:
    blender --background --python tools/asset_gen/build_stone_brick_assets.py -- \
        --tex assets/texture/stone_bricks --out assets/props/stone_bricks
"""
...
ASSETS = (
    ("stone_brick", "cube", "stone_brick.png"),
    ("infested_cracked_stone_bricks", "cube", "infested_cracked_stone_bricks.png"),
    ("chiseled_stone_brick", "cube", "chiseled_stone_brick.png"),
    ("stone_brick_stairs", "stairs", "stone_brick.png"),
)
...
def build_stairs(name: str, material) -> bpy.types.Object:
    # Highest rear tread reaches local Z=0; the block extends down to Z=-1.
